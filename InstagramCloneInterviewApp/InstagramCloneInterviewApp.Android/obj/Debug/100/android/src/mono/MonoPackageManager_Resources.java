...
public class MonoPackageManager_Resources {
	public static String[] Assemblies = new String[]{
		/* We need to ensure that "InstagramCloneInterviewApp.Android.dll" comes first in this list. */
		"InstagramCloneInterviewApp.Android.dll",
		"FFImageLoading.dll",
		"FFImageLoading.Platform.dll",
		"FormsViewGroup.dll",
		"InstagramCloneInterviewApp.dll",
		"Newtonsoft.Json.dll",
